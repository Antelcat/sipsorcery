...
public class RTCPeerSctpAssociation : SctpAssociation
{
    ...
    /// </summary>
    private readonly RTCSctpTransport rtcSctpTransport;
    ...
    {
        this.rtcSctpTransport = rtcSctpTransport;
        Logger.LogDebug($"SCTP creating DTLS based association, is DTLS client {this.rtcSctpTransport.IsDtlsClient}, ID {ID}.");
