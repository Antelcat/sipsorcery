...
internal class DtlsSrtpTlsAuthentication : TlsAuthentication
{
    ...
    public virtual TlsCredentials? GetClientCredentials(CertificateRequest certificateRequest)
    {
        ...
        return DtlsUtils.LoadSignerCredentials(context,
            ...
            client.certificateChain,
            client.privateKey);  // TODO?
    }
...
public class DtlsSrtpClient : DefaultTlsClient, IDtlsSrtpPeer
{
    ...
    internal readonly Certificate? certificateChain;
    internal readonly AsymmetricKeyParameter? privateKey;

    internal TlsClientContext TlsContext => mContext;
    ...
    public DtlsSrtpClient(Certificate? certificateChain, AsymmetricKeyParameter? privateKey, UseSrtpData? clientSrtpData = null)
    {
        ...
        if (clientSrtpData == null)
        {
            ...
            var mki = new byte[(SrtpParameters.SRTP_AES128_CM_HMAC_SHA1_80.GetCipherKeyLength() +
    ...
    public override void ProcessServerExtensions(IDictionary clientExtensions)
    {
        ...
        foreach (int profile in TlsSRTPUtils.GetUseSrtpExtension(clientExtensions).ProtectionProfiles)
        {
            switch (profile)
            {
