...
public class RTCPSenderReport
{
    ...
    {
        Header = new RTCPHeader(RTCPReportTypesEnum.SR, receptionReports?.Count ?? 0);
        SSRC = ssrc;
    ...
    {
        var rrCount = ReceptionReports?.Count ?? 0;
        ...
        const int payloadIndex = RTCPHeader.HEADER_BYTES_LENGTH;
