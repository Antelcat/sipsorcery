...
public sealed class RtpSessionConfig
{
    ...
    public bool IsSecure => RtpSecureMediaOption == RtpSecureMediaOptionEnum.DtlsSrtp;

    public bool UseSdpCryptoNegotiation => RtpSecureMediaOption == RtpSecureMediaOptionEnum.SdpCryptoNegotiation;
}